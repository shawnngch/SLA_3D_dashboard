  ...
  './LayerItem'
    ...
    var clazz = declare([BaseWidget], {
      ...
      _updateElevationLayers: function(){
        console.log("_updateElevationLayers")
      ...
      _addElevationLayerItem: function(layer){
        console.log("_addElevationLayerItem")
      ...
      _destroyAllElevationLayerItems: function(){
        console.log("_destroyAllElevationLayerItems")
      ...
      _createActionsFunction: function(event){
        console.log("_createActionsFunction")
        var actions = [];
